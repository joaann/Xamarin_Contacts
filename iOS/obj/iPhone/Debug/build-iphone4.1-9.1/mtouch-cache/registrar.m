...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "ContactsTest.iOS.AppDelegate, ContactsTest.iOS", "FinishedLaunching");
	}

	-(id) init
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, "ContactsTest.iOS.AppDelegate, ContactsTest.iOS", ".ctor");
	}
@end
...
@implementation Xamarin_Forms_Platform_iOS_ListViewRenderer_ListViewDataSource { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, p1, "UIKit.UIScrollView, Xamarin.iOS", "System.Boolean, mscorlib", "Xamarin.Forms.Platform.iOS.ListViewRenderer+ListViewDataSource, Xamarin.Forms.Platform.iOS", "DraggingEnded");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "ContactsTest.iOS.AppDelegate, ContactsTest.iOS", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [65].handle = objc_getClass ("UIApplicationShortcutItem");
	__xamarin_class_map [66].handle = objc_getClass ("UICollectionReusableView");
	...
	__xamarin_class_map [104].handle = objc_getClass ("UIGestureRecognizer");
