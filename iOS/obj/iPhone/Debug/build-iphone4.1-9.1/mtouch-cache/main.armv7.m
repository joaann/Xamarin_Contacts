...
extern void *mono_aot_module_ContactsTest_iOS_info;
...
extern void *mono_aot_module_ContactsTest_info;
extern void *mono_aot_module_Plugin_Contacts_Abstractions_info;
extern void *mono_aot_module_Plugin_Contacts_info;

void xamarin_register_modules ()
{
	mono_aot_register_module (mono_aot_module_ContactsTest_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_ContactsTest_info);
	mono_aot_register_module (mono_aot_module_Plugin_Contacts_Abstractions_info);
	mono_aot_register_module (mono_aot_module_Plugin_Contacts_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "ContactsTest.iOS.exe";
